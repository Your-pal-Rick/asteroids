...
class Asteroid(CircleShape):
    ...
    def split(self):
        ...
        if self.radius == ASTEROID_MIN_RADIUS:
            return ## I'm going to move this to the end of the method after I've implemented the rest. I don't need this check. It'll return if it fails the other checks.
